...
10. Handle orientation and varying screen sizes.
...
network loss, restart persistence, orientation — and offline/sync where
required.
...
simulator, store tokens insecurely, or skip the permission-denied path.
